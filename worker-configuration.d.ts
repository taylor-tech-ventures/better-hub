/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3329e06b288d5e183607d19720868dd0)
// Runtime types generated with workerd@1.20260301.1 2026-03-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server/index");
		durableNamespaces: "GitHubAgent" | "GitHubAgentEvents" | "PromptTemplateDO" | "GitHubMcpAgent";
	}
	interface DevEnv {
		OAUTH_KV: KVNamespace;
		ANALYTICS_CACHE: KVNamespace;
		AUTH_R2_BUCKET: R2Bucket;
		GH_ADMIN_D1_PRIMARY: D1Database;
		GH_AGENT_TOOL_CALLS: AnalyticsEngineDataset;
		ENVIRONMENT: "dev";
		CLOUDFLARE_ACCOUNT_ID: "16e8f7c4ab9857745900067adaee038a";
		...
		SUBSCRIPTION_LIMITS_FREE: string;
		SUBSCRIPTION_LIMITS_STANDARD: string;
		SUBSCRIPTION_LIMITS_UNLIMITED: string;
		PRICE_ID_STANDARD_MONTHLY: string;
		PRICE_ID_STANDARD_ANNUAL: string;
		PRICE_ID_UNLIMITED_MONTHLY: string;
		PRICE_ID_UNLIMITED_ANNUAL: string;
		CLOUDFLARE_ANALYTICS_API_TOKEN: string;
		GitHubAgent: DurableObjectNamespace<import("./server/index").GitHubAgent>;
		GitHubAgentEvents: DurableObjectNamespace<import("./server/index").GitHubAgentEvents>;
		PromptTemplateDO: DurableObjectNamespace<import("./server/index").PromptTemplateDO>;
		GitHubMcpAgent: DurableObjectNamespace<import("./server/index").GitHubMcpAgent>;
		ADMIN_ACTION_WORKFLOW: Workflow<Parameters<import("./server/index").AdminActionWorkflow['run']>[0]['payload']>;
	}
	interface ProdEnv {
		OAUTH_KV: KVNamespace;
		ANALYTICS_CACHE: KVNamespace;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CLOUDFLARE_ACCOUNT_ID" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "COOKIE_ENCRYPTION_KEY" | "AUTH_SECRET" | "SESSION_SECRET" | "JWT_SECRET" | "OPENAI_API_KEY" | "BASEURL" | "AUTH_URL" | "STRIPE_PRICE_ID" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET_SANDBOX" | "STRIPE_WEBHOOK_SECRET" | "CLOUDFLARE_D1_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_API_TOKEN" | "SUBSCRIPTION_LIMITS_FREE" | "SUBSCRIPTION_LIMITS_STANDARD" | "SUBSCRIPTION_LIMITS_UNLIMITED" | "PRICE_ID_STANDARD_MONTHLY" | "PRICE_ID_STANDARD_ANNUAL" | "PRICE_ID_UNLIMITED_MONTHLY" | "PRICE_ID_UNLIMITED_ANNUAL" | "CLOUDFLARE_ANALYTICS_API_TOKEN">> {}
}
