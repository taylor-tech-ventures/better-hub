        ...
        <Table>
          ...
          <TableBody>
            {sorted.map((item, rowIndex) => (
              // biome-ignore lint/suspicious/noArrayIndexKey: display-only table rows have no stable id
    ...
    LineChart: ({ props }) => {
      ...
      return (
        <div className="w-full">
          ...
          <ChartContainer
            config={chartConfig}
            className="min-h-50 w-full [&_svg]:overflow-visible"
            style={{ height: props.height ?? 300 }}
          >
      ...
      <div className="relative pl-8">
        ...
        <div className="flex flex-col gap-6">
          {(props.items ?? []).map((item) => {
            ...
            return (
              <div key={JSON.stringify(item)} className="relative">
                <div
